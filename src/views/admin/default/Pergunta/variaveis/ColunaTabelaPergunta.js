...
// export const ColunaTabelaPergunta = (tituloBotao1, nomeBotao1, tituloBotao2 = null, nomeBotao2 = null) => {
//     const { handleShow, handleShowResposta } = useUser();
...
//                         <p style={{ fontSize: 14 }}>{nomeBotao1}</p>
//                     </Button>
//                 </div>
//             ),
//         },
...
//                 <div className="App">
//                     <NavLink to="/admin/respostas">
//                         <Button variant="primary" onClick={() => handleShowResposta(row)}>
//                             <p style={{ fontSize: 14 }}>{nomeBotao2}</p>
//                         </Button>
//                     </NavLink>
//                 </div>
//             ),
